...
const Result = () => {
  ...
  const onSubmitHandler = async(e)=>{
    //this will be executed whenever we will add prompt and click on submit button
    e.preventDefault()//it will prevent the page from reloading whwnever we will submit the form
    setLoading(true)

    if (input) {
      //we have prompt in the input field
...
{isImageLoaded &&
    ...
    <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
      ...
      className='bg-transparennt border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'>Generate Another</p>
